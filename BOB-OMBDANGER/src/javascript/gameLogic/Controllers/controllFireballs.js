...
const fireballControlls = [ 
    ...
    { scoreThreshold: 5, spawnRate: 2, Speed:1, Radius:10,Color: "#000", customEffects: "null"},
    ...
    { scoreThreshold: 14, spawnRate: 1, Speed:4, Radius:250, Color: "#000", customEffects: "null"},
    { scoreThreshold: 15, spawnRate: 4, Speed:4, Radius:10, Color: "#000", customEffects: "null"},
    { scoreThreshold: 18, spawnRate: 10, Speed:2, Radius:11, Color: "#000", customEffects: "null"},
    { scoreThreshold: 22, spawnRate: 13, Speed:2, Radius:9, Color: "#000", customEffects: "null"},
    { scoreThreshold: 25, spawnRate: 14, Speed:1.8, Radius:7, Color: "#000", customEffects: "null"},
